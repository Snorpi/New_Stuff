...
def generate_course_html(csv_file, elective_file, elective_column="elective"):
    ...
    for row in data_list:
      ...
      <p style="text-align: center;"> </p>
      <p style="text-align: center;"><span style="text-decoration: underline; font-size: 24pt;"><strong>2024 7 + 1 Hour {elective_info.get('elective_name', '')} CE Webinar</strong></span></p>
      <p style="text-align: center;"> </p>
      <p style="text-align: center;"><span style="font-size: 14pt;">  This course fulfills the 7 + 1 Hour {elective_info.get('elective_name', '')} NMLS mortgage continuing education requirement for 2024 in a live webinar format. </span></p>
      <p style="text-align: center;"> </p>
      <p><a title="NMLS Webcam Requirement" href="https://nationwidelicensingsystem.org/courseprovider/Course%20Provider%Resources/Functional%20Specification%for%All%20NMLS%20Approved%Courses.pdf#page=27" target="_blank" rel="noopener noreferrer"><img style="display: block; margin-left: auto; margin-right: auto;" title="NMLS Webcam Requirement" src="https://mortgageeducators.com/images/00TemplateImages/webcam4.png" alt="Webcam Required, Per NMLS as of June 6th, 2022." width="652" height="129" /></a></p>
      ...
      <p> </p>
      <p><span style="text-decoration: underline; font-size: 12pt;"><strong>1 Hour {elective_info.get('elective_name', '')} Elective: {elective_info.get('course_number', '')}</strong></span></p>
      <p><span style="font-size: 12pt;">Chapter 1: {elective_info.get('chapter1', '')}</span></p>
      <p><span style="font-size: 12pt;">Chapter 2: {elective_info.get('chapter2', '')}</span></p>
      ...
      <p style="text-align: left;"> </p>
      <p><span style="font-size: 12pt;"><strong>***This live webinar course includes only the 7+1 hours of {elective_info.get('elective_name', '')} CE material. If you need additional state education, those can be found <a href="https://mortgageeducators.com/articles?id=751" target="_blank" rel="noopener noreferrer">HERE</a> in an online format***</strong></span></p>
      <p style="text-align: left;"><span style="font-size: 12pt;">Includes the NMLS $12 banking fee. </span></p>
...
 participation. </span></p>
      ...
      """
        ...
        filename = f"{row['instructor_fname']}-{row['course_date']}.html"  # Example filename

        with open(filename, 'a', encoding='utf-8') as output_file:
            output_file.write(html_content)
        # Do something with the generated HTML (e.g., save to file, display)
